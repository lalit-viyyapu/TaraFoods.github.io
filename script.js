...
const pickles = [
    { name: 'Chicken Pickle', price: 1500, img: 'https://via.placeholder.com/300x200?text=Chicken+Pickle', desc: 'A spicy and flavorful chicken pickle.', available: true, type: 'nonveg' },
    { name: 'Mutton Pickle', price: 2000, img: 'https://via.placeholder.com/300x200?text=Mutton+Pickle', desc: 'Tender mutton pieces in aromatic spices.', available: true, type: 'nonveg' },
    { name: 'Fish Pickle', price: 1200, img: 'https://via.placeholder.com/300x200?text=Fish+Pickle', desc: 'Tangy and spicy fish pickle.', available: true, type: 'nonveg' },
    { name: 'Prawns Pickle', price: 2000, img: 'https://via.placeholder.com/300x200?text=Prawns+Pickle', desc: 'Juicy prawns in a spicy mix.', available: true, type: 'nonveg' },
    { name: 'Gongura Chicken Pickle', price: 1500, img: 'https://via.placeholder.com/300x200?text=Gongura+Chicken+Pickle', desc: 'Chicken with tangy gongura leaves.', available: true, type: 'nonveg' },
    { name: 'Tomato Pickle', price: 600, img: 'https://via.placeholder.com/300x200?text=Tomato+Pickle', desc: 'Classic tangy tomato pickle.', available: true, type: 'veg' },
    { name: 'Ginger Pickle', price: 800, img: 'https://via.placeholder.com/300x200?text=Ginger+Pickle', desc: 'Zesty ginger pickle.', available: true, type: 'veg' },
    { name: 'Coriander Pickle', price: 800, img: 'https://via.placeholder.com/300x200?text=Coriander+Pickle', desc: 'Fresh coriander pickle.', available: true, type: 'veg' },
    { name: 'Amla Pickle', price: 800, img: 'https://via.placeholder.com/300x200?text=Amla+Pickle', desc: 'Healthy amla pickle.', available: true, type: 'veg' },
    { name: 'Pandu Mirapakaya Pickle', price: 600, img: 'https://via.placeholder.com/300x200?text=Pandu+Mirapakaya+Pickle', desc: 'Spicy ripe red chilli pickle.', available: true, type: 'veg' },
    { name: 'Drumstick Pickle', price: 600, img: 'https://via.placeholder.com/300x200?text=Drumstick+Pickle', desc: 'Unique drumstick pickle.', available: true, type: 'veg' },
    { name: 'Munagaaku Pickle', price: 600, img: 'https://via.placeholder.com/300x200?text=Munagaaku+Pickle', desc: 'Drumstick leaves pickle.', available: true, type: 'veg' },
    { name: 'Curry Leaf Pickle', price: 600, img: 'https://via.placeholder.com/300x200?text=Curry+Leaf+Pickle', desc: 'Aromatic curry leaf pickle.', available: true, type: 'veg' },
    { name: 'Avakaya Pickle', price: 600, img: 'https://via.placeholder.com/300x200?text=Avakaya+Pickle', desc: 'Classic mango avakaya.', available: true, type: 'veg' },
    { name: 'Maagaya Pickle', price: 800, img: 'https://via.placeholder.com/300x200?text=Maagaya+Pickle', desc: 'Traditional maagaya pickle.', available: true, type: 'veg' },
    { name: 'Pudina Pickle', price: 800, img: 'https://via.placeholder.com/300x200?text=Pudina+Pickle', desc: 'Refreshing mint pickle.', available: true, type: 'veg' },
    { name: 'Kakarkay Pickle', price: 600, img: 'https://via.placeholder.com/300x200?text=Kakarkay+Pickle', desc: 'Bitter gourd pickle.', available: true, type: 'veg' },
  ];
    ...
    return `
      <div class="col-md-4 mb-4">
        <div class="card h-100 ${isVeg ? 'veg-card' : 'nonveg-card'}">
          <img src="${pickle.img}" class="card-img-top" alt="${pickle.name}">
