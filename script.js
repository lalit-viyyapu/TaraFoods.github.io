...
const pickles = [
  { name: 'Chicken Pickle', price: 1500, img: '', desc: 'A spicy and flavorful chicken pickle.', available: true, type: 'nonveg' },
  { name: 'Mutton Pickle', price: 2000, img: '', desc: 'Tender mutton pieces in aromatic spices.', available: true, type: 'nonveg' },
  { name: 'Fish Pickle', price: 1200, img: '', desc: 'Tangy and spicy fish pickle.', available: true, type: 'nonveg' },
  { name: 'Prawns Pickle', price: 2000, img: '', desc: 'Juicy prawns in a spicy mix.', available: true, type: 'nonveg' },
  { name: 'Gongura Chicken Pickle', price: 1500, img: '', desc: 'Chicken with tangy gongura leaves.', available: true, type: 'nonveg' },
  { name: 'Tomato Pickle', price: 600, img: '', desc: 'Classic tangy tomato pickle.', available: true, type: 'veg' },
  { name: 'Ginger Pickle', price: 800, img: '', desc: 'Zesty ginger pickle.', available: true, type: 'veg' },
  { name: 'Coriander Pickle', price: 800, img: '', desc: 'Fresh coriander pickle.', available: true, type: 'veg' },
  { name: 'Amla Pickle', price: 800, img: '', desc: 'Healthy amla pickle.', available: true, type: 'veg' },
  { name: 'Pandu Mirapakaya Pickle', price: 600, img: '', desc: 'Spicy red chili pickle.', available: true, type: 'veg' },
  { name: 'Drumstick Pickle', price: 600, img: '', desc: 'Unique drumstick pickle.', available: true, type: 'veg' },
  { name: 'Munagaaku Pickle', price: 600, img: '', desc: 'Drumstick leaves pickle.', available: true, type: 'veg' },
  { name: 'Curry Leaf Pickle', price: 600, img: '', desc: 'Aromatic curry leaf pickle.', available: true, type: 'veg' },
  { name: 'Avakaya Pickle', price: 600, img: '', desc: 'Classic mango avakaya.', available: true, type: 'veg' },
  { name: 'Maagaya Pickle', price: 800, img: '', desc: 'Traditional maagaya pickle.', available: true, type: 'veg' },
  { name: 'Pudina Pickle', price: 800, img: '', desc: 'Refreshing mint pickle.', available: true, type: 'veg' },
  { name: 'Kakarkay Pickle', price: 600, img: '', desc: 'Bitter gourd pickle.', available: true, type: 'veg' },
];
